                            ...
                            <div class="card-header d-sm-flex d-block pb-0 border-0">
                                ...
                                <div class="dropdown custom-dropdown d-block mt-3 mt-sm-0 mb-0">
                                    <div class="btn border border-warning btn-sm d-flex align-items-center svg-btn"
                                        ...
                                        <svg class="mr-2" width="42" height="42" viewBox="0 0 42 42"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <div class="basic-form">
                                    <form class="form-wrapper">
                                        ...
                                        <div class="row mt-4 align-items-center">
                                            <div class="col-lg-6">
                                                <div>
                                                    <p class="mb-0 fs-14">Lorem ipsum dolor sit amet,
                                            ...
                                            <div class="col-lg-6">
                                                <div class="d-flex justify-content-end">
                                                    <a href="javascript:void(0);"
                                                        class="btn  btn-success text-white text-nowrap">
                                                        BUY
                                                        <svg class="ml-3 scale3" width="16" height="16"
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        SELL
                                                        <svg class="ml-3 scale5" width="16" height="16"
                                        ...
                                        <table class="table shadow-hover card-table border-no tbl-btn short-one">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="wspace-no">
                                                        <svg class="mr-1" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                            ...
                            <div class="card-body">
                                ...
                                <div class="row pt-sm-5 pt-3 align-items-center">
                                    <div class="col-sm-6 mb-sm-0 mb-3">
                                        <p class="mb-0 fs-14">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit, sed do eiusmod tempor incididunt ut</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <a href="javascript:void(0);"
                                            class="btn btn-secondary d-block btn-lg">TRANSFER NOW</a>
                                    </div>
                                </div>
                            </div>
                        </div>
