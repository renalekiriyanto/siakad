...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit jadwal mata pelajaran</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control form-control"
                                                ...
                                                value="{{ old('mapel', $jadwalmapel->mapel->nama) }}">
                                            <input type="hidden" name="id_mapel" id="id_mapel"
                                                value="{{ old('id_mapel', $jadwalmapel->id_mapel) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control form-control" placeholder="Kelas"
                                                id="kelas" name="kelas"
                                                value="{{ old('kelas', $jadwalmapel->kelas->nama) }}" readonly>
                                            <input type="hidden" name="id_kelas" id="id_kelas"
                                                value="{{ old('id_kelas', $jadwalmapel->id_kelas) }}">
                                            <div class="input-group-append">
                                                ...
                                                <div class="card">
                                                    <table class="table table-borderless">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    id="nama_kelas">{{ $jadwalmapel->kelas->nama }}</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Tahun Ajaran</td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group clockpicker">
                                                    <input type="text" class="form-control" id="jam_mulai"
                                                        name="jam_mulai"
                                                        value="{{ old('jam_mulai', $jadwalmapel->jam_mulai) }}">
    ...
    <script>
        ...
        if (id_mapel.value || id_kelas.value) {
            card_mapel.style.display = "block";
            card_kelas.style.display = "block";
            pilihMapel(id_mapel.value);
            pilihKelas(id_kelas.value);
        }
